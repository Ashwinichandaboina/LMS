    ...
    <footer className='bg-gray-900 md:px-36 text-left w-full mt-10'>
      ...
      md:px-0 justify-center gap-10 md:gap-32 py-10 border-b border-white/30'>
       <div className='flex flex-col md:items-start items-center w-full'>
        <img src={assets.logo_dark} alt="logo" className='-mt-4'/>
...
<h2 className='font-semibold text-white mb-5'>Subscribe to our newsletter </h2>
   <p className='text-sm text-white/80'> The latest news,articles,and resources,sent to your inbox weekly</p>
      ...
      <p className='py-4 text-center text-xs md:text-sm text-white/60'>Copyright 2025 @ Learnova.All Right Reserved
      </p>
    </footer>
  )
}
