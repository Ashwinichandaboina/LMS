  ...
  if(action=== 'add'){
    ...
    if(title){
      const newChapter ={
        ...
        chapterContent:[],
        collapsed:false,
        chapterOrder: chapters.length >0 ? chapter.slice(-1)[0].chapterOrder + 
        1 : 1,
      };
        ...
        {chapters.map((chapter,chapterIndex)=>(
          <div key={chapterIndex} className='bg-white rounded-lg mb-4'>
           ...
           src={assets.cross_icon} alt="" className='cursor-pointer' />
            ...
            {!chapter.collapsed && (
              <div className='p-4'>
                {chapter.chapterContent.map((lecture,letureIndex)=>(
                  <div key={letureIndex} className='flex justify-between 
                  items-center mb-2'>
                    <span>{letureIndex + 1} {lecture.lectureTitle} -{lecture.
                    ...
                    <img src={assets.cross_icon} alt="" onClick={()=>handleLecture
                      ('remove',chapter.chapterId,letureIndex)}
